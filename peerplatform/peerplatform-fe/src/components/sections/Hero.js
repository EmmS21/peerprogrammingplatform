    ...
    if (bttn === "pair") {
      try {
        const tokenResponse = await fetch(
          `${profileURL}voice_chat/token/${nickname}`,
        );
      ...
      <div className="container-sm">
        <div className={innerClasses}>
          <div className="hero-content">
            ...
            >
              Practice programming challenges for interviews{" "}
              <span className="text-color-primary">guided by AI</span>
            </h1>
            <div className="container-xs">
              ...
              <div className="reveal-from-bottom" data-reveal-delay="600">
                ...
                >
                  ...
                  >
                    <Button
                      className="flash-on-hover"
                      type="primary"
                      onClick={(e) =>
                        handleSelect(e, e.currentTarget.innerText)
                      }
                ...
                <div>
                  <h2>How it works</h2>
                  <div>
                    Practice programming challenges guided by advice and tips
                    from AI to help you learn more effectively and ace your
                    interviews.
                  </div>
                </div>
                {isLoginModalVisible && (
                ...
                {isSignupModalVisible && (
                  <SignupModal
                    closeModal={() => setIsSignupModalVisible(false)}
                  />
                )}
              </div>
            </div>
